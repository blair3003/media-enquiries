            ...
            <div className="space-y-12">
                ...
                <fieldset className="border-b border-gray-900/10 pb-8">
                    <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="sm:col-span-4 space-y-2">
                            <label htmlFor="media"
                                   className="block text-sm font-medium leading-6 text-gray-900">Media</label>
                            <div
                                className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-sm">
                                <select
                                    name="media_id"
                        ...
                        <div className="sm:col-span-4 space-y-2">
                            <label htmlFor="reporter"
                                   className="block text-sm font-medium leading-6 text-gray-900">Reporter</label>
                            <div
                                className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-sm">
                                <select
                                    name="reporter_id"
                        ...
                        <div className="sm:col-span-4 space-y-2">
                            <label htmlFor="deadline"
                                   className="block text-sm font-medium leading-6 text-gray-900">Deadline</label>
                            <div
                                className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-sm">
                                <input
                                    type="date"
                        ...
                        <div className="sm:col-span-4 space-y-2">
                            <label htmlFor="ooh" className="block text-sm font-medium leading-6 text-gray-900">
                                Out of Hours (OOH)
                            </label>
                            <div className="flex">
                                <input
